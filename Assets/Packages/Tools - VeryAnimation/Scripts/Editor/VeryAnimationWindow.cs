    ...
    internal class VeryAnimationWindow : EditorWindow
    {
...
#endif
        {
            ...
            protected override void SelectionChanged(IList<int> selectedIds)
            {
                ...
                var clip = EditorUtility.EntityIdToObject(state.lastClickedID) as AnimationClip;
#else
...
#pragma warning restore IDE0051
        ...
        public GUIStyle GuiStyleCenterAlignYellowLargeBoldLabel { get; private set; }
        ...
        private void GUIStyleReady()
        {
            ...
            if (GuiStyleCenterAlignYellowLargeBoldLabel == null)
            {
                GuiStyleCenterAlignYellowLargeBoldLabel = new GUIStyle(EditorStyles.largeLabel)
                {
                    alignment = TextAnchor.MiddleCenter,
                    fontStyle = FontStyle.Bold,
                    fontSize = 20,
                };
                GuiStyleCenterAlignYellowLargeBoldLabel.normal.textColor = Color.yellow;
            }
        ...
        private string prevLunchedVersion;
        ...
        private void OnEnable()
        {
            ...
            prevLunchedVersion = EditorPrefs.GetString("VeryAnimation_Main_PrevLunchedVersion", "0.0.0");
        ...
        private void OnGUI()
        {
            ...
            else if (!VA.IsEdit)
            {
                ...
                errorLogScrollPosition = EditorGUILayout.BeginScrollView(errorLogScrollPosition);
                {
                    #region UnityVersion
                    {
#if UNITY_6000_4_OR_NEWER || !UNITY_2021_3_OR_NEWER
        ...
        private void VersionInfoGUI()
        {
            ...
            if (prevLunchedVersion != Version)
            {
                EditorGUILayout.LabelField("Link to Quick Start Video ↓", GuiStyleCenterAlignYellowLargeBoldLabel);
                EditorGUILayout.Space();
            }
        ...
        public void Initialize()
        {
            ...
            {
                EditorPrefs.SetString("VeryAnimation_Main_PrevLunchedVersion", Version);
                prevLunchedVersion = Version;
            }
