...
namespace VolFx
{
    [Serializable, VolumeComponentMenu("VolFx/Bloom (VolFx)")]
    public sealed class BloomVol : VolumeComponent, IPostProcessComponent
    {
        ...
        public ClampedFloatParameter m_Intensity = new ClampedFloatParameter(0, 0, 21);
        ...
        public ClampedFloatParameter m_Scatter   = new ClampedFloatParameter(.7f, 0, 1);
        ...
        // =======================================================================
        public bool IsActive() => active && m_Intensity.value > 0f;
