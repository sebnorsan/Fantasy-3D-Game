...
public class HandsSmooth : MonoBehaviour
{
	...
	float init_maxAmount, init_maxRotAmount, init_rotMovMult = 0;
	...
	private void Start()
	{
		...
		init_maxAmount = maxAmount;
		init_maxRotAmount = MaxRotationAmount;
		init_rotMovMult = RotationMovementMultipler;
	}
	private void Update()
	{
	...
	public void UnassignMaxAmounts()
	{
		maxAmount = 0;
		MaxRotationAmount = 0;
		RotationMovementMultipler = 0;
	}
	public void ReassignMaxAmounts()
	{
		maxAmount = init_maxAmount;
		MaxRotationAmount = init_maxRotAmount;
		RotationMovementMultipler = init_rotMovMult;
	}
}
